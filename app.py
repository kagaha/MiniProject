...
def main():
    ...
    if choice == "Home":
        ...
        st.subheader("Emoji Detection in Text")
        ...
        st.write("Welcome to the Emoji/Emotion Detection in Text App! This application utilizes the power of natural language processing and machine learning to analyze and identify emotions in textual data.")
